...
x = setInterval(function() {
  ...
  function anim() {
    ...
    if (done) {
      ...
      // Show pop-up after confetti animation ends
      showPopUp("Ik I couldn't be present for your birthday but I desperately want to be there for you rn. Even if it's your bday, I'm full of excitement to meet you asap and celebrate YOU together. I love youuu moree, idiot <33 ");
    }
  }
  ...
  function showPopUp(message) {
    ...
    // You can style the pop-up box and its content using CSS
  }
